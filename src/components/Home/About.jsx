...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "I purchased a car from Hadnall Motors and it was the quickest, smoothest experience! I reserved the car and viewed on the Saturday, picking it up less than 24 hours later. I highly reccomend these guys! The staff were fab.",
    name: "Tia Haskell",
  },

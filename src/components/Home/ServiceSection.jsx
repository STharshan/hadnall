...
const services = [
  {
    title: "Used vehicle Selling",
    desc: `Selling best used vehicle`,
    image: "/carpaint.avif",
    path: "/services/mechanical",
  },
  {
    title: "Part Exchange",
    desc: `process where you trade in your old vehicle or part to reduce the cost of purchasing a new one.
​`,
    image: "/gray.avif",
  ...
  {
    title: "Fnance",
    desc: `Our finance specialists are able to give finance to people who ordinarily wouldn't be able to get it`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[60%] mt-15 mx-auto h-26 object-cover"
                    onError={(e) => {

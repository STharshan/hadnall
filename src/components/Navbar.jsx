...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-black backdrop-blur-md dark:bg-[#242427]/95 dark:backdrop-blur-md py-2 text-white font-semibold shadow-lg">
